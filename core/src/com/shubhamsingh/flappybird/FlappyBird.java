package com.shubhamsingh.flappybird;
...
public class FlappyBird extends ApplicationAdapter {
    ...
    public void startGame() {
        ...
        for (int i = 0; i < numberOfTubes; i++) {
            ...
            tubeX[i] = (Gdx.graphics.getWidth() - topTube.getWidth()) / 2 + Gdx.graphics.getWidth() +
    ...
    public void render() {
        ...
        batch.draw(birds[flapState], Gdx.graphics.getWidth() / 2 - birds[flapState].getWidth() / 2,
                birdY);
        font.draw(batch, String.valueOf(score), Gdx.graphics.getWidth()/2 - font.getXHeight()/2, Gdx.graphics.getHeight()-300);
